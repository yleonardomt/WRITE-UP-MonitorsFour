...
*Writeup by YH0N4T4NR00T — HackTheBox Season 10 · Febrero 2026*

---

Ahí tienes el writeup completo con tu voz, con las flags en `xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`, explicando cada CVE a fondo, la lógica del `token=0`, qué es Docker Desktop y por qué la API expuesta es tan grave. Puedes copiarlo directamente a un archivo `.md` en tu Obsidian, Notion o donde guardes tus notas. ¿Quieres que ajuste alguna sección o agregue algo más?
